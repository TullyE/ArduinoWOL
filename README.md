...
This is my first time creating any kind of documentation like this so any feedback you have would be greatly appriciated
# Required materials:
...
Repeat 4 more times until you have 5 Integer Data Streams (`V0, V1, V2, V3, V4`)  
